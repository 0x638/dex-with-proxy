...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = rawAPI or fetchViaProxy("http://setup.roblox.com/"..Main.RobloxVersion.."-API-Dump.json")
		else
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.RobloxVersion = Main.RobloxVersion or fetchViaProxy("http://setup.roblox.com/versionQTStudio")
		end
